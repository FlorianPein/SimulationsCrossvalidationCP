...
tab1 <- readRDS(file = paste("results/Blocks2028out20.RDS", sep = ""))
tab2 <- readRDS(file = paste("results/Blocks2028out30.RDS", sep = ""))
...
tab <- xtable::xtable(tab, digits = rep(4, 2 + 4 * 2), auto = TRUE, display = c("g", "s", rep(c("g","g","g","g"), 2)),
              ...
              caption = "Outlier ...")
print(tab, include.rownames = FALSE, file = paste("results/combined_Out.tex", sep = ""),
