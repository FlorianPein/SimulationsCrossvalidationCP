...
tab1 <- readRDS(file = paste("results/arlot_s1_c.RDS", sep = ""))
tab2 <- readRDS(file = paste("results/arlot_s1_pc3.RDS", sep = ""))
tab3 <- readRDS(file = paste("results/arlot_s1_s.RDS", sep = ""))
...
tab <- xtable::xtable(tab, digits = rep(4, 2 + 4 * 2), auto = TRUE, display = c("g", "s", rep(c("g","g","g","g"), 2)),
              ...
              caption = "Arlot I ...")
print(tab, include.rownames = FALSE, file = paste("results/ArlotTab1.tex", sep = ""),
...
tab <- xtable::xtable(tab, digits = rep(4, 2 + 4 * 1), auto = TRUE, display = c("g", "s", rep(c("g","g","g","g"), 1)),
              ...
              caption = "Arlot II ...")
print(tab, include.rownames = FALSE, file = paste("results/ArlotTab2.tex", sep = ""),
      append = FALSE, sanitize.text.function=function(x){x})  
