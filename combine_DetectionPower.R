...
tab1 <- readRDS(file = paste("results/detection_lambda_6_delta_2.RDS", sep = ""))
tab2 <- readRDS(file = paste("results/detection_lambda_6_delta_3.RDS", sep = ""))
tab3 <- readRDS(file = paste("results/detection_lambda_6_delta_4.RDS", sep = ""))
tab4 <- readRDS(file = paste("results/detection_lambda_8_delta_2.RDS", sep = ""))
tab5 <- readRDS(file = paste("results/detection_lambda_12_delta_2.RDS", sep = ""))
tab6 <- readRDS(file = paste("results/detection_lambda_20_delta_2.RDS", sep = ""))
...
print(tab, include.rownames = FALSE, file = paste("results/DetectionTab1.tex", sep = ""),
...
print(tab, include.rownames = FALSE, file = paste("results/DetectionTab2.tex", sep = ""),
      append = FALSE, sanitize.text.function=function(x){x})  
...
print(tab, include.rownames = FALSE, file = paste("results/DetectionTab3.tex", sep = ""),
      append = FALSE, sanitize.text.function=function(x){x})  
