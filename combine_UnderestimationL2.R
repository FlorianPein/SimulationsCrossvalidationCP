...
tab1 <- readRDS(file = paste("results/UnderestimationL2.RDS", sep = ""))
tab2 <- readRDS(file = paste("results/UnderestimationL2mod.RDS", sep = ""))
...
print(tab, include.rownames = FALSE, file = paste("results/combined_UnderestimationL2.tex", sep = ""),
