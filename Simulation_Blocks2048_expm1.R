...
saveRDS(est, file = paste("results/EstBlocks2028expm1.RDS", sep = ""))
saveRDS(mse, file = paste("results/MseBlocks2028expm1.RDS", sep = ""))
...
tab <- xtable(tab, digits = rep(4, 6), auto = TRUE, display = c("g","s","g","g","g", "g"),
              align = c("l", "l|", "c", "c", "c", "c"),
              caption = "test")
saveRDS(tab, file = paste("results/Blocks2028expm1.RDS", sep = ""))
print(tab, include.rownames = FALSE, file = paste("results/Blocks2028expm1.tex", sep = ""),
