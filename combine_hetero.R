...
tab1 <- readRDS(file = paste("results/Blocks2028hetero_0to8.RDS", sep = ""))
tab2 <- readRDS(file = paste("results/Blocks2028hetero32_0to8.RDS", sep = ""))
...
print(tab, include.rownames = FALSE, file = paste("results/combined_Hetero_0to8.tex", sep = ""),
